...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : lun. 22 mai 2023 à 09:25
...
CREATE TABLE IF NOT EXISTS `etage` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=ascii COLLATE=ascii_general_ci COMMENT='Ma table étage';
...
CREATE TABLE IF NOT EXISTS `etudiants` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=ascii COLLATE=ascii_general_ci COMMENT='Ma table étuditants';
...
CREATE TABLE IF NOT EXISTS `salles` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=ascii COLLATE=ascii_general_ci COMMENT='Ma table salles';
